...
DEVICE_PATH := device/samsung/dali
...
BOARD_RAMDISK_OFFSET := 0x01400000
...
# Assert
TARGET_OTA_ASSERT_DEVICE := dali

# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 6537472 # This is the maximum known partition size, but it can be higher, so we just omit it
